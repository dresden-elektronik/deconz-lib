...
public:
    ...
    DECONZ_API_DEPRECATED QString toStringExt() const;
    /*! Returns the network address as string in form or 0x0011. */
    DECONZ_API_DEPRECATED QString toStringNwk() const;
    /*! Returns the groups address as string in form or 0x0011. */
    DECONZ_API_DEPRECATED QString toStringGroup() const;
     ...
     */
    DECONZ_API_DEPRECATED bool fromStringExt(const QString &str);
    /*! Returns true if \p str could be parsed and was set as network address.
        \param str a string holding a hexadecimal address
     */
    DECONZ_API_DEPRECATED bool fromStringNwk(const QString &str);
